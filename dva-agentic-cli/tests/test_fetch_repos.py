...
from dva_agentic_cli.mcp_tool_client import MCPToolError, parse_project_key
...
from dva_agentic_cli.commands.domain import _interactive_repo_picker
...
MCP_PATCH = "dva_agentic_cli.mcp_tool_client"
