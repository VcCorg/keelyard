...
from dva_agentic_cli.kg.sync import (
...
class TestSyncToLightrag:
    @patch("dva_agentic_cli.kg.sync.get_repos", return_value=SAMPLE_REPOS)
    @patch("dva_agentic_cli.kg.sync.get_projects", return_value=SAMPLE_PROJECTS)
    @patch("dva_agentic_cli.kg.sync.get_activity", return_value=SAMPLE_ACTIVITIES)
    @patch("dva_agentic_cli.kg.sync.get_activity_summary", return_value=SAMPLE_SUMMARY)
    def test_sync_all(self, mock_summary, mock_activity, mock_projects, mock_repos):
        ...
        with patch("dva_agentic_cli.kg.config.KGConfig") as mock_config_cls, \
             patch("dva_agentic_cli.kg.lightrag_client.LightRAGClient", return_value=mock_client):
    ...
    @patch("dva_agentic_cli.kg.sync.get_repos", return_value=[])
    @patch("dva_agentic_cli.kg.sync.get_projects", return_value=[])
    @patch("dva_agentic_cli.kg.sync.get_activity", return_value=[])
    @patch("dva_agentic_cli.kg.sync.get_activity_summary", return_value={})
