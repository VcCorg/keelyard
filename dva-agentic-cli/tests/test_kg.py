...
from dva_agentic_cli.commands.kg import load_data_config, resolve_data_source
...
class TestParsers:
    ...
    def test_parse_text(self, tmp_path):
        ...
        from dva_agentic_cli.kg.parsers import parse_text
    ...
    def test_parse_json(self, tmp_path):
        ...
        from dva_agentic_cli.kg.parsers import parse_json
    ...
    def test_parse_csv(self, tmp_path):
        ...
        from dva_agentic_cli.kg.parsers import parse_csv
...
class TestQuery:
    ...
    def test_simple_query_to_cypher(self):
        ...
        from dva_agentic_cli.kg.query import simple_query_to_cypher
    ...
    def test_format_result(self):
        ...
        from dva_agentic_cli.kg.query import format_result
...
class TestDataSourceIntegration:
    ...
    def test_load_data_config_empty(self, tmp_path):
        ...
        with patch("dva_agentic_cli.commands.kg.CONFIG_FILE", tmp_path / "nonexistent.json"):
    ...
    def test_load_data_config_with_data(self, tmp_path):
        ...
        with patch("dva_agentic_cli.commands.kg.CONFIG_FILE", config_file):
            config = load_data_config()
