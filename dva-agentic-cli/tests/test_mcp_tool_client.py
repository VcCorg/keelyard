...
from dva_agentic_cli.mcp_tool_client import (
    MCPToolClient,
    MCPToolError,
    parse_project_key,
    parse_space_key,
...
class TestMCPToolClient:
    ...
    def test_call_tool_connection_error(self):
        ...
        with patch("dva_agentic_cli.mcp_tool_client.call_mcp_tool",
    ...
    def test_call_tool_success(self):
        ...
        with patch("dva_agentic_cli.mcp_tool_client.call_mcp_tool", return_value=mock_result):
            client = MCPToolClient("http://localhost:9999/sse")
