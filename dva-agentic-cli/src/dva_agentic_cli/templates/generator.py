...
from dva_agentic_cli.templates.enums import Framework, UseCase, Tool
...
class TemplateGenerator:
    ...
    def _generate_pyproject(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.pyproject import get_pyproject_content
    ...
    def _generate_readme(self, target_dir: Path) -> None:
        """Generate README.md."""
        from dva_agentic_cli.templates.files.readme import get_readme_content
    ...
    def _generate_env_example(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.env import get_env_content
    ...
    def _generate_makefile(self, target_dir: Path) -> None:
        """Generate Makefile."""
        from dva_agentic_cli.templates.files.makefile import get_makefile_content
        content = get_makefile_content()
        (target_dir / "Makefile").write_text(content)
    
    def _generate_gitignore(self, target_dir: Path) -> None:
        """Generate .gitignore."""
        from dva_agentic_cli.templates.files.gitignore import get_gitignore_content
    ...
    def _generate_main(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.main import get_main_content
    ...
    def _generate_config(self, target_dir: Path) -> None:
        """Generate config.py."""
        from dva_agentic_cli.templates.files.config import get_config_content
    ...
    def _generate_agents(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.agents import generate_agent_files
    ...
    def _generate_a2a(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.a2a import generate_a2a_files
        generate_a2a_files(target_dir, self.config)
    
    def _generate_kg_mcp(self, target_dir: Path) -> None:
        """Generate KG MCP server files."""
        from dva_agentic_cli.templates.files.kg_mcp import generate_kg_mcp_files
    ...
    def _generate_kg_workspace(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.kg_mcp import generate_kg_workspace_files
    ...
    def _generate_pr_reviewer(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.pr_reviewer import generate_pr_reviewer_files
    ...
    def _generate_skill(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.skill import generate_skill
    ...
    def _generate_onboard(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.onboard import generate_onboard_files
    ...
    def _generate_scrum_master(self, target_dir: Path) -> None:
        ...
        from dva_agentic_cli.templates.files.scrum_master import generate_scrum_master_files
