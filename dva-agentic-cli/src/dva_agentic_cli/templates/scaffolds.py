...
from dva_agentic_cli.templates.enums import Framework, Tool, UseCase
from dva_agentic_cli.templates.config import TemplateConfig, USE_CASE_TOOLS
...
def scaffold_agent(
    ...
    from dva_agentic_cli.templates.files.tools import TOOL_TEMPLATES
...
def _scaffold_complex_support(
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if agent_type == "pr-reviewer":
            from dva_agentic_cli.templates.files.pr_reviewer import (
                generate_pr_reviewer_files,
            )
            generate_pr_reviewer_files(tmp, config)
        elif agent_type == "scrum-master":
            from dva_agentic_cli.templates.files.scrum_master import (
