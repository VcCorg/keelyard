...
from dva_agentic_cli.analyzer.detector import analyze_project, ProjectAnalysis
...
def _run_agent(
    ...
    Otherwise, uses the built-in pipeline from dva_agentic_cli.agents.onboard.
    """
    if agent_path:
...
def onboard(
    ...
    if kg:
        ...
        try:
            from dva_agentic_cli.kg.context_builder import run_kg_context_pipeline
