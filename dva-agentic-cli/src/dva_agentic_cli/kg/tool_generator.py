...
def generate_tool(name: str, operations: List[str]) -> str:
    ...
    if "search" in operations:
        imports.append("from dva_agentic_cli.kg.search import search_graph")
    if "query" in operations:
        imports.append("from dva_agentic_cli.kg.query import execute_query")
...
Generated by: dva kg tool generate
"""
