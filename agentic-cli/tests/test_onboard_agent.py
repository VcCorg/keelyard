...
def temp_proposals_dir(tmp_path, monkeypatch):
    ...
    proposals.mkdir()
    monkeypatch.setattr("agentic_cli.analyzer.matcher.PROPOSALS_DIR", proposals)
    return proposals
...
class TestProposalStorage:
    ...
    def test_load_no_dir(self, tmp_path, monkeypatch):
        monkeypatch.setattr(
            "agentic_cli.analyzer.matcher.PROPOSALS_DIR",
...
class TestOnboardAgent:
    @patch("agentic_cli.agents.onboard.gap_detector.init_model")
    ...
    @patch("agentic_cli.agents.onboard.skill_generator.init_model")
    ...
    @patch("agentic_cli.agents.onboard.models.init_model")
