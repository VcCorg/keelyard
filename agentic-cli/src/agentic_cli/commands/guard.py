...
Phase one of KeelGuard: the Bill of Materials, with no verdict attached.
Composing components into a risk judgement is a governance question and belongs
where every other governance dial lives, so this enumerates and stops.
"""
