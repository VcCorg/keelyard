...
- Later, ``dva domain build-snapshot <slug>`` shells out to the ``devin`` DRS
    ...
    *,
    ...
    blueprint: dict[str, Any] = {
        ...
        "metadata": {
            ...
            "generated_by": "dva domain init-meta",
        },
    ...
    header = (
        ...
        "# Generated by `dva domain init-meta` (blueprint-now, build-later model).\n"
        f"# Build a snapshot from this with: dva domain build-snapshot {domain}\n"
        "#\n"
        ...
        "# (adjust keys as needed, then `dva domain gen-blueprint` can be updated).\n\n"
    )
